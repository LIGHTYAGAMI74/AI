  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b-[4px] md:border-b-[6px] border-black">
      ...
      <div className="flex justify-between items-center px-4 sm:px-6 md:px-8 py-4 md:py-5">
        ...
        {/* LOGO */}
        <Link href="/">
          <div className="text-xl sm:text-2xl md:text-3xl font-black bg-yellow-400 border-[3px] md:border-4 border-black px-3 py-1 -rotate-2 shadow-[3px_3px_0px_black]">
            AI OLYMPIAD
          </div>
        </Link>
